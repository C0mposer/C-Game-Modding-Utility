...
- Real-time memory watch and editing
...
**Working with game symbols:** Define addresses in `symbols/default.txt`, declare types in `include/symbols.h`, then use them like normal variables. [Full symbol guide](wiki-link)
